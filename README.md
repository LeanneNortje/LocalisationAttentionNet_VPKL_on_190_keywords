# Using LocalistionAttentionNet trained on 190 keywords to do VPKL
...
```
git clone https://github.com/LeanneNortje/LocalisationAttentionNet_VPKL_on_190_keywords.git
```

To get into the repository run:

```
cd LocalisationAttentionNet_VPKL_on_190_keywords/
```
